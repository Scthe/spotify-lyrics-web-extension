...
// the result is 'spotify-lyrics-popup.zip' in root dir of this app
...
var OUT_FILE = 'spotify-lyrics-popup.zip';
...
output.on('close', function () {
  ...
  console.log(
    "The file '" +
      OUT_FILE +
      "' was succesfully created. Ready to upload to the extension store!"
  );
});
